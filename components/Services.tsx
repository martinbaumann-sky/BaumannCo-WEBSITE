...
const Services: React.FC = () => {
  ...
  return (
    <section id="services" className="py-20 bg-brand-accent/5 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, index) => (
            <button 
              ...
              className="group bg-white p-8 rounded-2xl border border-brand-accent/30 shadow-[0_4px_20px_-10px_rgba(0,0,0,0.05)] hover:shadow-[0_20px_40px_-15px_rgba(27,54,93,0.1)] hover:-translate-y-1 transition-all duration-500 ease-out hover:border-brand-primary/30 text-left cursor-pointer w-full"
            >
              ...
              <h4 className="text-xl font-semibold text-brand-primary mb-2 group-hover:text-brand-secondary transition-colors">{service.title}</h4>

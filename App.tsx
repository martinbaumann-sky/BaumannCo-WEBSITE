             ...
             <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
               ...
               <div className="lg:w-1/2 relative group">
                 ...
                 <div className="absolute -bottom-6 -right-6 bg-white p-6 rounded-xl shadow-xl z-20 max-w-xs hidden md:block border border-brand-accent/20">
                    ...
                    <p className="text-xs text-brand-grey uppercase tracking-wider">{t.about.reach}</p>
                 </div>
               </div>

               <div className="lg:w-1/2">
                 <span className="text-brand-primary font-bold tracking-widest uppercase text-xs mb-4 block opacity-80">{t.about.tag}</span>
        ...
        <section id="methodology" className="py-24 bg-brand-primary text-white relative overflow-hidden">
           ...
           <div className="container mx-auto px-6 md:px-12 relative z-10">
             <div className="text-center max-w-3xl mx-auto mb-16">
               ...
               <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif mb-6">{t.methodology.title}</h2>
